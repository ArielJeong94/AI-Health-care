...
## 소개
이 레포는 AI 헬스케어 개발자로 성장하기 위해 공부한 내용을 정리하는 공간입니다.  
...
## 학습 목표
- Git & GitHub 사용을 자연스럽게 만들기
- VSCode + CLI 기반 개발 환경에 익숙해지기
- Python으로 간단한 실습 코드들을 작성할 수 있게 되기
- 나의 학습 과정을 시간순으로 남겨, 나중에 포트폴리오처럼 보여줄 수 있게 만들기
